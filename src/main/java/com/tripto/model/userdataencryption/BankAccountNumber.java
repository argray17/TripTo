...
public class BankAccountNumber {
  ...
  private static final byte[] salt = new String("13248472").getBytes();
  ...
  public BankAccountNumber(String bankAccountNumber) throws Exception {
    key = createSecretKey(bankAccountNumber.toCharArray());
    encryptedBankAccountNumber = encrypt(bankAccountNumber, key);
  }
  ...
  private SecretKeySpec createSecretKey(char[] unencryptedBankAccountNumber)
      throws NoSuchAlgorithmException, InvalidKeySpecException {
    SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA512");
    PBEKeySpec keySpec =
        new PBEKeySpec(unencryptedBankAccountNumber, salt, iterationCount, keyLength);
